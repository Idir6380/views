...
function ContactForm(props) {
    return (
        <div className='contact-form'>
            <div className='div-1'>
                <h1>
                    <span className='heading-span'>Ge</span>t in <span className="break"></span> <span className='heading-span-2'>tou</span>ch
                </h1>
            ...
            <form className='row '>
                <div className='col-md-5 input-1'>
                ...
                <div className='col-md-7 col-sm-12 input-2'>
